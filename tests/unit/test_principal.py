from project.blueprints.filial.filialService import add_filiais, get_all_filiais
from project.db.database import read_db
import json,os
TEST_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)),"db","test_db_principal.json")

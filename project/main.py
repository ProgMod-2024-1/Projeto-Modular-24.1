...
AVALIACAO_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "avaliacao", "database",
                                "avaliacao.json")
CERTIFICACAO_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "certificacao", "database",
                                   "certificacao.json")
CRITERIO_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "criterios", "database",
                               "criterios.json")
CURSO_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "curso", "database", "curso.json")
FILIAL_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "filial", "database",
                             "filial.json")
FORMACAO_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "formacao", "database",
                               "formacao.json")
LISTA_DE_ESPERA_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "lista_de_espera",
                                      "database", "lista_de_espera.json")
USERS_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "principal", "database",
                            "users.json")
PROFESSOR_DB_URI = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blueprints", "professor", "database",
                                "professor.json")
